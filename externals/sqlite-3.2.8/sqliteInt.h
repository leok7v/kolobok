...
#pragma warning(disable: 4101)  // : 'rc' : unreferenced local variable
...
#pragma warning(disable: 4245)  // : 'initializing' : conversion from 'const long ' to 'const unsigned int ', signed/unsigned mismatch
#pragma warning(disable: 4761)  // : integral size mismatch in argument; conversion supplied

// TODO: these two need more attention:-
#pragma warning(disable: 4701)  // : local variable 'wrote' may be used without having been initialized
#pragma warning(disable: 4706)  // : assignment within conditional expression

// basetsd.h causes this:-
